...
import pytest
from source_helium_api.source import HeliumApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(HeliumApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(HeliumApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(HeliumApiStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = HeliumApiStream()
