...
import pytest
from source_coingecko.source import CoingeckoStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(CoingeckoStream, "path", "v0/example_endpoint")
    mocker.patch.object(CoingeckoStream, "primary_key", "test_primary_key")
    mocker.patch.object(CoingeckoStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = CoingeckoStream()
